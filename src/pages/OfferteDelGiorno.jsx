...
const OfferteDelGiorno = ({ products, addToCart }) => {
  const offerteProducts = products.filter(p => p.category === 'Offerte');

  return (
    <div style={{ backgroundColor: '#f0f2f5', minHeight: '100vh' }}>
      <Container className="py-4">
        <h2 className="mb-4">Offerte del Giorno</h2>
        <Row>
          {offerteProducts.map(product => (
