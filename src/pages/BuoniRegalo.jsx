...
const BuoniRegalo = ({ products, addToCart }) => {
  const buoniRegaloProducts = products.filter(p => p.category === 'Buoni Regalo');

  return (
    <div style={{ backgroundColor: '#f0f2f5', minHeight: '100vh' }}>
      <Container className="py-4">
        <h2 className="mb-4">Buoni Regalo</h2>
        <Row>
          {buoniRegaloProducts.map(product => (
